        ...
        <div v-if="record == editedRecord">
          <form action="" @submit.prevent="updateRecord(record)">
            <div class="mb-6 p-4 bg-white rounded border border-grey-light mt-4">
              ...
              <div class="mb-6">
                 <select id="artist_update" class="appearance-none py-3 px-4 pr-8 block 
                                                   w-full bg-grey-lighter border 
                                                   border-grey-lighter text-grey-darker 
                                                   rounded leading-tight focus:outline-none focus:bg-white focus:border-grey" 
